...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "부동산과 경영의 융합을 통해 효율적인 의사결정과 지속 가능한 개발을 이루어내고자 합니다.\n\n\n\n\n\n\n\n\n\n\n\n\n 이를 위해 지속적인 학습과 실습을 통해 경험을 쌓아가고 있습니다.",
    background: {"image":"","video":"","color":"#b7b79e","opacity":0.5},
    experienceCards: [{"icon":"graduation","title":"도시계획·부동산학부 부동산학 전공","period":"2021 -","description":"부동산 시장 분석과 도시 재개발에 대한 깊은 이해를 바탕으로, 지속 가능한 부동산 개발과 도시의 미래를 설계하는 방법을 배우고 있습니다."},{"icon":"graduation","title":"경영학부 경영학 부전공","period":"2022 -","description":"경영학적 사고와 실무 능력을 강화하고, 부동산과 경영을 융합하여 효율적인 의사결정과 문제 해결 능력을 개발하고 있습니다."},{"icon":"briefcase","title":"중·고등부 영어 강사","period":"2025 -","description":"학생들에게 영어 문법과 회화 능력을 지도하며, 언어 능력 향상과 더불어 글로벌 역량을 키우는 데에 기여하고 있습니다."},{"icon":"calendar","title":"도시계획·부동산학부 라온학생회","period":"2021","description":"홍보부 업무 담당"}],
    skills: [{"icon":"pieChart","title":"숫자와 데이터 활용 능력","description":"통계학적 분석과 빅 데이터 활용을 통해 부동산 트렌드와 시장 예측을 정확하게 도출할 수 있습니다. 데이터를 기반으로 정확한 의사결정을 내리고, 효율적인 투자 전략을 수립합니다."},{"icon":"globe","title":"글로벌 소통 역량","description":"영어 교육을 통해, 국제적인 협업에서 글로벌 소통 능력을 발휘하며, 다양한 배경을 가진 사람들과 효과적으로 의사소통할 수 있습니다. "},{"icon":"users","title":"협력과 공존 역량","description":"팀 프로젝트에서의 경험을 바탕으로, 다양한 사람들과 협력하여 공동의 목표를 달성하는 방법을 익혔습니다. 팀워크와 협력을 통해 창의적인 해결책을 찾아내는 것을 즐깁니다."},{"icon":"brain","title":"전략적 계획 및 실행 역량","description":"시간표 조정과 학업 진도 관리를 통해 체계적이고 전략적인 계획을 수립하고, 학생들이 효율적으로 목표를 달성할 수 있도록 지원했습니다. 학습 경로를 맞춤형으로 설계하고, 목표를 구체적으로 설정하여 성과를 높일 수 있었습니다."},{"icon":"megaphone","title":"마케팅 전략가로서의 역량","description":"단과대 학생회 홍보부에서 활동하며 브랜드 홍보와 이벤트 기획을 담당했습니다. 다양한 홍보 전략을 통해 학생들의 참여를 이끌어내고, 학교 커뮤니티의 활성화에 기여했습니다. 디지털 콘텐츠 제작과 소셜 미디어 활용을 통해 학교와 관련된 정보를 효과적으로 전달하는 능력을 길렀습니다."}],
    storyTitle: "데이터 기반 사고와 마케팅적 관점을 갖춘 부동산·경영 융합형 인재",
    story: ["전공 과정에서 배운 도시재생·부동산 시장 분석 경험을 기반으로, 실제 프로젝트에서는 Project REITs 활용 도시재개발 제안, 마케팅 적용 전략 연구, 브랜드 리뉴얼 절차 등 소비자 관점과 정책·시장 구조를 함께 고려한 해결 중심 프로젝트를 수행했습니다.","또한 분석으로 끝나는 것이 아니라, 사람을 움직이기 위한 실행 경험도 함께 쌓아왔습니다. 단과대 SNS 운영, 기획 등 직접 캠페인을 운영하며 콘텐츠 전략을 구성했습니다. 이를 통해 단순 아이디어가 아닌 실행 가능한 프로젝트와 결과를 만들어내는 과정의 중요성을 배웠습니다.","교육 분야에서는 중·고등부 영어 강사로 활동하며 학생별 데이터 기반 성취 추세 관리, 기말고사 대비 일정 설계, 문법 분석 콘텐츠 제작 등 학습 효율을 높이는 시스템을 직접 설계·운영해 보았습니다. 이 경험은 제가 사람의 성장과 성취를 돕는 일에 높은 책임감을 가지고 있다는 것을 확신하게 해주었습니다.","저는 단순히 주어진 문제를 해결하는 사람보다, 문제의 구조를 먼저 정의하고, 실행 가능한 방법을 설계하며, 실제 변화를 만드는 사람이 되고자 합니다. 앞으로도 변화의 속도를 두려워하지 않고, 데이터와 관찰, 그리고 사람에 대한 이해를 기반으로 새로운 프로젝트에 도전하겠습니다."],
    storyImage: "/uploads/about-image-1765028808280.png",
    hobbies: ["📚 독서 및 시 필사","☕ 카페 투어 (수도권)","🎬 애니메이션 감상"]
  }
